                                ...
                                <tr>
                                    ...
                                    <th style="color:#660066; font-size:23px;font:bolder">DOB</th>
                                     <th style="color:#660066; font-size:23px;font:bolder">State</th>
                                           <th style="color:#660066; font-size:23px;font:bolder">Add</th>
                                </tr>
                                <br></br>
                                <tr>
                                   <%
                                    ...
                                    <td style="font-size:18px;font:bolder;color:whitesmoke"><a href="added_proxy.jsp?fname=<%=rs.getString("uname")%>&email=<%=rs.getString("email")%>" >Add</a> </td>
                                </tr>
                                <%}
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
