                ...
                <table border="0" align='center' width="1000px" hieght="1200px" style="text-align: center;background-color:#ffff00">
                                ...
                                <tr>
                                   <%
                                    ...
                                    <td style="font-size:18px;font:bolder;color:whitesmoke"><a href="activate_owner.jsp?fname=<%=rs.getString("fname")%>&email=<%=rs.getString("email")%>" ><%=rs.getString("status")%></a> </td>
                                </tr>
                                <%}
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
