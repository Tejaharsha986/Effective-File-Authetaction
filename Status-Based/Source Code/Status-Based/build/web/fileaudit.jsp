            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0"  style="font-size: 20px;line-height: 1.5">
                ...
                <table border="0" align='center' width="1000px" hieght="1200px" style="text-align: center;background-color:#ffff00">
                                ...
                                <tr>
                                    ...
                                    <th style="color:#660066; font-size:23px;font:bolder">Audit</th>
                                </tr>
                                <br></br>
                                <tr>
                                   <%
                                    ...
                                    <td style="font-size:18px;font:bolder;"><a href="file_view.jsp?fname=<%=rs1.getString("file_name")%>">View</a> </td>
                                </tr>
                                <%}
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
