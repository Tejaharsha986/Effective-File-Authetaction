            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0"  style="font-size: 20px;line-height: 1.5">
                ...
                <table border="0" align='center' width="1000px" hieght="1200px" style="text-align: center;background-color:#ffff00">
                                ...
                                <tr>
                                    ...
                                    <th style="color:#660066; font-size:23px;font:bolder">Proxy Name</th>
                                ...
                                <tr>
                                   <%
                                        try {
                                            String owner=null,mail=null,state=null;
                                            Connection con;
                                            Statement st;
                                            ResultSet rs;
                                             ResultSet rs1;
                                            ...
                                            rs1=st.executeQuery("select * from files where req='"+"Active"+"'");
                                            while (rs1.next()) {
                                    ...
                                    <td style="font-size:18px;font:bolder"><%=mail%></td>
                                    <td style="font-size:18px;font:bolder"><%=state%></td>
                                  
                                    <td style="font-size:18px;font:bolder;"><a href="audit_mail.jsp?fname=<%=rs1.getString("file_name")%>&email=<%=mail%>" >Send</a> </td>
                                </tr>
                                <%}
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
