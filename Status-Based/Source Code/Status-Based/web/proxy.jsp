...
.container {
        ...
        <table border="2" width="100%" style="font-weight: bold;text-align: center">
            <tr height="590px">
                ...
                <td width="30%">
                    ...
                    <br><br>
                   <form action="proxylogin">
   
    <input type="email" id="name" name="name" placeholder="PROXY EMAIL ID" size="30" style="padding:10px;border-radius: 10px">
    <br><br><br>
    ...
    <br><br>
    Don't Have an account? <a href='proxyreg.jsp' style='text-decoration: none'>Sign Up</a>
