    ...
    <body>
        <table border="2" width="100%" style="font-weight: bold;text-align: center">
            <tr height="590px">
                ...
                <td width="30%">
                    <h2>Registry Server Login Here</h2>
                    <br><br>
                   <form action="registrylogin">
   
    <input type="text" id="name" name="name" placeholder="SERVER ID" size="30" style="padding:10px;border-radius: 10px">
    <br><br><br>
