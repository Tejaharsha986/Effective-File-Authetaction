    ...
    <body>
        <table border="0" width="100%" bgcolor="3498db" cellspacing="0" cellpadding="0" style="color:white;text-align: center;">
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0"  style="font-size: 20px;line-height: 1.5">
                <tr height="550px">
                    <td width="20%">
                        <a href="registry_page.jsp" style="font-size: 26px;text-decoration: none;color: #95a5a6">Registry Home</a><br><br>
                        <a href="view_owner.jsp" style="font-size: 26px;text-decoration: none;color: #95a5a6" >Owner Details</a><br><br>
                        <a href="view_proxy.jsp" style="font-size: 26px;text-decoration: none;color: #95a5a6">Proxies Details</a><br><br>
                        <a href="processfile.jsp" style="font-size: 26px;text-decoration: none;color: #95a5a6">Processed File</a><br><br>
                ...
                <table border="0" align='center' width="1000px" hieght="1200px" style="text-align: center;background-color:#ffff00">
                                ...
                                <tr>
                                   <%
                                    ...
                                    <td style="font-size:18px;font:bolder;color:whitesmoke"><a href="activate_proxy.jsp?fname=<%=rs.getString("fname")%>&email=<%=rs.getString("email")%>" ><%=rs.getString("status")%></a> </td>
                                </tr>
                                <%}
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
