                                ...
                                <tr>
                                   <%
                                        try {
                                            ...
                                            rs = st.executeQuery("select * from proxyreg where issued='"+"Added"+"'");
                                            while (rs.next()) {

                                    %>
                                    <td style="font-size:18px;font:bolder"><%=rs.getString("proxyid")%></td>
                                    <td style="font-size:18px;font:bolder" ><%=rs.getString("skey")%></td>
